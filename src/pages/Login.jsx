            ...
            <div className="max-w-md w-full glass-card border-t border-white/10 relative z-10 p-8 sm:p-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-2">
                        <label className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest pl-1">Email Protocol</label>
                ...
                <div className="mt-8 text-center text-[10px] text-neutral-600 uppercase tracking-wider">
                    New to the system?{' '}
                    <Link to="/signup" className="text-neutral-400 hover:text-white font-bold transition-colors border-b border-transparent hover:border-white/50 pb-0.5 ml-1">
                        Initialize
                    </Link>
                </div>
            </div>
